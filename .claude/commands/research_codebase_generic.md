...
4. **Wait for all sub-agents to complete and synthesize findings:**
   ...
   - Verify all thoughts/ paths are correct (e.g., thoughts/flakecode/ not thoughts/shared/ for personal files)
...
5. **Gather metadata for the research document:**
   ...
   - Run `gh repo view --json name -q '.name'` to get REPO_NAME, then save as `thoughts/shared/research/REPO_NAME/YYYY-MM-DD-ISSUE-NUM-description.md`
...
- **Path handling**: The thoughts/searchable/ directory contains hard links for searching
  ...
  - Examples of correct transformations:
    - `thoughts/searchable/flakecode/old_stuff/notes.md` → `thoughts/flakecode/old_stuff/notes.md`
    - `thoughts/searchable/shared/prs/123.md` → `thoughts/shared/prs/123.md`
    - `thoughts/searchable/global/shared/templates.md` → `thoughts/global/shared/templates.md`
  - NEVER change flakecode/ to shared/ or vice versa - preserve the exact directory structure
