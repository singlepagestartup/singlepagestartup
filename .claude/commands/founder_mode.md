...
1. get the sha of the commit you just made (if you didn't make one, read `.claude/commands/utilities/commit.md` and make one)
...
8. gh pr create --fill
9. read '.claude/commands/utilities/describe_pr.md' and follow the instructions
