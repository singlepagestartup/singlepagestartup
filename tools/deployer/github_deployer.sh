...
BACKEND_SERVICE_NAME=$(get_env "$BASH_SOURCE" "BACKEND_SERVICE_NAME")
BACKEND_SERVICE_SUBDOMAIN=$(get_env "$BASH_SOURCE" "BACKEND_SERVICE_SUBDOMAIN")
BACKEND_DOCKER_HUB_REPOSITORY_NAME=$(get_env "$BASH_SOURCE" "BACKEND_DOCKER_HUB_REPOSITORY_NAME")

HOST_SERVICE_NAME=$(get_env "$BASH_SOURCE" "HOST_SERVICE_NAME")
HOST_SERVICE_SUBDOMAIN=$(get_env "$BASH_SOURCE" "HOST_SERVICE_SUBDOMAIN")
HOST_DOCKER_HUB_REPOSITORY_NAME=$(get_env "$BASH_SOURCE" "HOST_DOCKER_HUB_REPOSITORY_NAME")
