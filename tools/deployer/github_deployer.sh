...
MCP_INTERNAL_TOKEN_EXCHANGE_SECRET=$(get_env "$BASH_SOURCE" "MCP_INTERNAL_TOKEN_EXCHANGE_SECRET")
MCP_PROJECT_URL=$(get_env "$BASH_SOURCE" "MCP_PROJECT_URL")
...
SECRETS=(\
    ...
    "MCP_INTERNAL_TOKEN_EXCHANGE_SECRET $MCP_INTERNAL_TOKEN_EXCHANGE_SECRET" \
    "MCP_PROJECT_URL $MCP_PROJECT_URL" \
