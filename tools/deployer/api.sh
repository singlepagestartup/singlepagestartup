...
FILE_STORAGE_MAX_UPLOAD_BYTES=$(get_env_or_default "$BASH_SOURCE" "FILE_STORAGE_MAX_UPLOAD_BYTES" "52428800")
...
then
    ...
    ansible-playbook \
        ...
        -e "SERVICE_NAME=$SERVICE_NAME \
            ...
            FILE_STORAGE_MAX_UPLOAD_BYTES=$FILE_STORAGE_MAX_UPLOAD_BYTES \
