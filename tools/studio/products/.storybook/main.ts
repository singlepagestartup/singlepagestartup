...
export default {
  ...base,
  stories: [
    path.join(root, "tools/studio/products/fixtures/Pages.stories.tsx"),
  ],
  staticDirs: [
    {
      from: path.join(root, "tools/studio/products/fixtures/startup"),
      to: "/workspace-products/startup",
    },
