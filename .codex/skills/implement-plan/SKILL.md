---
name: "implement-plan"
description: "Implements a specific plan file manually."
---

# implement-plan

Canonical source: `.agents/workflows/engineering/implement_plan.md`.

## Execution Contract

1. Read `.agents/workflows/engineering/implement_plan.md` fully before executing.
