...
Primary workflow skill. Canonical source: `.agents/workflows/engineering/core/30-implement.md`.

## Required Behavior

1. Read `.agents/workflows/engineering/core/30-implement.md` completely.
...
- Accept the same inputs as `.agents/workflows/engineering/core/30-implement.md` (issue number and optional flags/paths).
