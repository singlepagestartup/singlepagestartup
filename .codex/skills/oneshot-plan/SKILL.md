...
Legacy orchestration alias. Canonical source: `.agents/workflows/engineering/oneshot_plan.md`.

## Required Behavior

1. Read `.agents/workflows/engineering/oneshot_plan.md` completely and execute its process: planning phase, the explicit status advancement to `Ready for Dev`, then the implementation phase.
