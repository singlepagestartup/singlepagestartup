...
export default function CodeFrameworkPresentation({
  ...
  return (
    <ProjectPresentation
      name={data.name}
      slides={PROJECT_PRESENTATION_SLIDES.map((slide, index) => ({
        ...slide,
        content:
          slide.id === "cover" ? (
            <main
            ...
            <SlideFrame
              data={data}
              index={index}
              source="Code Framework presentation"
            >
