...
Every material below serves the `makers` Sales segment, along its journey from a demonstration or question to the repository. No current material addresses the `developer-agents` segment, whose adoption happens through documentation an agent reads rather than through promotion; whether that segment needs its own material is an open decision for the project owner.
...
| Material                                                                                                  | Sales segment and journey context                      | Role and destination                                                                                                            |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| [Walkthrough cover](marketing-creative/walkthrough-cover.md)                                              | `makers` · discovery, before the first result          | Introduce a full explanation of building a product with an agent. The video description leads to the framework and maker guide. |
| [Repository preview](marketing-creative/repository-preview.md)                                            | `makers` · a shared link reaching a deciding maker     | Identify the reusable foundation and its value when the GitHub link is shared.                                                  |
| [Short cover](marketing-creative/short-cover.md) and [storyboard](marketing-creative/short-storyboard.md) | `makers` · first contact, one idea                     | Introduce the idea in a 30-second vertical story and lead to the related full video.                                            |
| [Article](marketing-creative/article.md)                                                                  | `makers` · evaluation, what to reuse and what to build | Explain what to reuse and what to change for a business. Lead to the framework.                                                 |
| [Social post](marketing-creative/social-post.md)                                                          | `makers` · a community question turning into interest  | Open a conversation around a concrete business rule and link to Code Framework.                                                 |
