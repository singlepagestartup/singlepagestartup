...
The cover opens the landing page. The article and social post lead to `/register`. Each published link retains its destination and campaign identifier so visits and registrations can be compared by material. Covers and posts use the selected fixed artboards; the article remains a readable long-form page.
