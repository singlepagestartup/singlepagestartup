...
describe("ArtifactDocument", () => {
  ...
  test("shows Brief instead of the internal startup.brief ID", () => {
    ...
    expect(html).toContain("misdirects every later decision");
    expect(html).not.toContain("Use it to");
   ...
   * Then the visible heading says Assets and hides the technical kind
   */
