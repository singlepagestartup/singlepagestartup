...
export function registerResources(mcp: McpServer) {
  mcp.registerResource(
    "crm-relations-forms-to-steps",
    "sps://crm/forms-to-steps",
    {
...
export function registerTools(mcp: McpServer) {
  registerCountTool(
    mcp,
    "crm-forms-to-steps-count",
    "Count crm forms to steps",
    "Count crm forms to steps entities with optional filters.",
    crmFormsToStepsApi,
  );

  mcp.registerTool(
    "crm-forms-to-steps-get",
    {
      title: "List of crm forms-to-steps relations",
      description: "Get list of all forms-to-steps relations from crm module.",
      inputSchema: {},
    },
    async () => {
  ...
  mcp.registerTool(
    "crm-forms-to-steps-get-by-id",
    {
      title: "Get crm forms-to-steps relation by id",
      description: "Get a forms-to-steps relation by id.",
      inputSchema: {
  ...
  mcp.registerTool(
    "crm-forms-to-steps-post",
    {
      title: "Create crm forms-to-steps relation",
  ...
  mcp.registerTool(
    "crm-forms-to-steps-patch",
    {
      title: "Update crm forms-to-steps relation by id",
  ...
  mcp.registerTool(
    "crm-forms-to-steps-delete",
    {
      title: "Delete crm forms-to-steps relation by id",
