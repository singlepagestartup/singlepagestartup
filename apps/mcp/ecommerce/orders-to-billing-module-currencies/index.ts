...
export function registerResources(mcp: McpServer) {
  mcp.registerResource(
    "ecommerce-relations-orders-to-billing-module-currencies",
    "sps://ecommerce/orders-to-billing-module-currencies",
    {
      title: "ecommerce orders-to-billing-module-currencies relation",
      description:
...
export function registerTools(mcp: McpServer) {
  mcp.registerTool(
    ...
    {
      title: "List of ecommerce orders-to-billing-module-currencies relations",
      description:
        "Get list of all orders-to-billing-module-currencies relations from ecommerce module.",
      inputSchema: {},
    },
  ...
  mcp.registerTool(
    "ecommerce-orders-to-billing-module-currencies-get-by-id",
    {
      title: "Get ecommerce orders-to-billing-module-currencies relation by id",
      description: "Get a orders-to-billing-module-currencies relation by id.",
      inputSchema: {
  ...
  mcp.registerTool(
    "ecommerce-orders-to-billing-module-currencies-post",
    {
      title: "Create ecommerce orders-to-billing-module-currencies relation",
      description:
  ...
  mcp.registerTool(
    "ecommerce-orders-to-billing-module-currencies-patch",
    {
      title:
        "Update ecommerce orders-to-billing-module-currencies relation by id",
      description:
  ...
  mcp.registerTool(
    "ecommerce-orders-to-billing-module-currencies-delete",
    {
      title:
        "Delete ecommerce orders-to-billing-module-currencies relation by id",
      description:
