...
export function registerTools(mcp: McpServer) {
  registerCountTool(
    mcp,
    "ecommerce-attribute-keys-to-attributes-count",
    "Count ecommerce attribute keys to attributes",
    "Count ecommerce attribute keys to attributes entities with optional filters.",
    ecommerceAttributeKeysToAttributesApi,
  );
