...
HOST_SERVICE_REVALIDATION_SECRET=$(get_env "$BASH_SOURCE" "HOST_SERVICE_REVALIDATION_SECRET" "../api/.env")
add_env "HOST_SERVICE_REVALIDATION_SECRET" $HOST_SERVICE_REVALIDATION_SECRET
