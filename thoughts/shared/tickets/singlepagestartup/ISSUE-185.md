# Issue: [log-watch] [LW-6a66ca6ff01e] api_api Call to 'sendMessage' failed! (403: Forbidden: bot was blocked by the user)

## Metadata

**URL**: https://github.com/singlepagestartup/singlepagestartup/issues/185
**Issue**: #185
...
- Source issue: https://github.com/flakecode/doctorgpt/issues/21
...
Copied from https://github.com/flakecode/doctorgpt/issues/21

Original repository: `flakecode/doctorgpt`
Original issue: #21
Original author: @flakecode
Original created at: 2026-05-03T00:00:04Z
Original updated at: 2026-05-03T00:00:04Z

---

Automated production log watchdog found this error more than 3 times in the last `1h`.

Fingerprint: `LW-6a66ca6ff01e`
Detected at: `2026-05-03T00:00:03+00:00`
Service: `api_api`
...
[ERROR] 🚨 Exception [o-4gL2Tb-HzzdyfSZjAKe] POST http://api:4000/api/notification/notifications/bd0c54d5-b858-4932-8db7-4dcaa6eee8e3/send? {
  "message": "Call to 'sendMessage' failed! (403: Forbidden: bot was blocked by the user)",
  "stack": "Error: Call to 'sendMessage' failed! (403: Forbidden: bot was blocked by the user)\n    at new HTTPException (/usr/src/app/node_modules/hono/dist/http-exception.js:6:5)\n    at <anonymous> (/usr/src/app/libs/modules/notification/models/notification/backend/app/api/src/lib/controller/singlepage/send/index.ts:40:17)\n    at processTicksAndRejections (native:7:39)",
  "status": 403,
  "causes": [
    {
      "message": "Call to 'sendMessage' failed! (403: Forbidden: bot was blocked by the user)",
...
[ERROR] 🚨 Exception [nv9FhbaJo89Z4UguvkPtR] POST http://api:4000/api/rbac/subjects/2bd15ae9-8d22-4c70-a878-a4ca1b152fdf/notify {
  "message": "Call to 'sendMessage' failed! (403: Forbidden: bot was blocked by the user)",
  "stack": "Error: Call to 'sendMessage' failed! (403: Forbidden: bot was blocked by the user)\n    at new HTTPException (/usr/src/app/node_modules/hono/dist/http-exception.js:6:5)\n    at <anonymous> (/usr/src/app/libs/modules/rbac/models/subject/backend/app/api/src/lib/controller/singlepage/notify.ts:244:17)\n    at processTicksAndRejections (native:7:39)",
  "status": 403,
  "causes": [
...
```text
api_api||Call to 'sendMessage' failed! (403: Forbidden: bot was blocked by the user)
```
