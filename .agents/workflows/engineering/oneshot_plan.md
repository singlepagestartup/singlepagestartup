...
2. Read and follow `.agents/workflows/engineering/core/20-plan.md` for the issue.
3. After planning completes, the issue is in `Plan in Review`. Since the operator explicitly chose the combined flow, advance it and continue:
   ...
   ```
4. Read and follow `.agents/workflows/engineering/core/30-implement.md` for the same issue.
