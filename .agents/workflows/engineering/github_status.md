...
The helper resolves the target repository from `.agents/contracts/engineering/repository-context.md`, filters Project items by both issue number and repository URL, and fails if existing local artifacts point at a different Project.
