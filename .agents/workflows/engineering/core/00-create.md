...
Before any GitHub issue command or `thoughts/shared/...` path resolution, follow `.agents/contracts/engineering/repository-context.md`.
...
2. **Create local ticket file**:
   ...
   - Follow the structure in `.agents/contracts/engineering/process-artifact.md`
