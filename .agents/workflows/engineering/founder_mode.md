...
1. get the sha of the commit you just made (if you didn't make one, read `.agents/workflows/engineering/utilities/commit.md` and make one)

2. read `.agents/workflows/engineering/linear.md` - think deeply about what you just implemented, then create a linear ticket about what you just did, and put it in 'in dev' state - it should have ### headers for "problem to solve" and "proposed solution"
