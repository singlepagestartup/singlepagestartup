...
- Hit a wrong assumption, tooling failure, or dead end? Record it as an incident in the process log per `.agents/contracts/engineering/process-artifact-contract.md`.
