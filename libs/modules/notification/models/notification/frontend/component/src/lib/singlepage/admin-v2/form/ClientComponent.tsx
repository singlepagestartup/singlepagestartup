...
export function Component(props: IComponentPropsExtended) {
  ...
  const relationSections = useMemo(() => {
    return [
      {
        id: "topics-to-notifications",
        title: "Topics",
        render: props.topicsToNotifications,
      },
      {
        id: "notifications-to-templates",
        title: "Templates",
        render: props.notificationsToTemplates,
      },
    ].filter(
      (
        section,
  ...
  }, [props.topicsToNotifications, props.notificationsToTemplates]);
