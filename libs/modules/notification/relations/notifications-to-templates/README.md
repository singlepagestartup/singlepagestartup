# Notification Notifications to Templates Relation

## Purpose

Links notifications to templates.
...
- `templateId`: linked template ID.

## Variants

- `default`: renders the related template using its frontend variant.
