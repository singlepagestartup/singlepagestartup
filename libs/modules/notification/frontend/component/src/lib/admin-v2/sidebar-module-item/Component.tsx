...
export function Component(props: IComponentProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Link href={ADMIN_BASE_PATH + "/notification"}>
      ...
      {isCurrentModule ? (
        <div className="mt-2 space-y-1 pl-3">
          <Notification isServer={props.isServer} url={props.url} />
          <Template isServer={props.isServer} url={props.url} />
          <Topic isServer={props.isServer} url={props.url} />
