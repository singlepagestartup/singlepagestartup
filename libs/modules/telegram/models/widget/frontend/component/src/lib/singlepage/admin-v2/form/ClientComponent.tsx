...
import { api } from "@sps/telegram/models/widget/sdk/client";
import { useForm } from "react-hook-form";
import { FormField } from "@sps/ui-adapter";
import { z } from "zod";
import { zodResolver } from "@hookform/resolvers/zod";
import { variants, insertSchema } from "@sps/telegram/models/widget/sdk/model";
...
export function Component(props: IComponentPropsExtended) {
    ...
    return [
      {
        id: "pages-to-widgets",
        title: "Pages",
        render: props.pagesToWidgets,
      },
      {
        id: "widgets-to-external-widgets",
        title: "External Widgets",
        render: props.widgetsToExternalModules,
      },
    ].filter(
      (
        section,
  ...
  }, [props.pagesToWidgets, props.widgetsToExternalModules]);
