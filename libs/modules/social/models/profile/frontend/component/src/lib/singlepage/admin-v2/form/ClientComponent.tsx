...
export function Component(props: IComponentPropsExtended) {
  ...
  const relationSections = useMemo(() => {
    return [
      ...
      {
        id: "profiles-to-file-storage-module-files",
        title: "Files",
        render: props.profilesToFileStorageModuleFiles,
      },
      {
        id: "profiles-to-attributes",
        title: "Attributes",
        render: props.profilesToAttributes,
      },
      {
      ...
      {
        id: "profiles-to-chats",
        title: "Chats",
        render: props.profilesToChats,
      },
      {
        id: "profiles-to-actions",
        title: "Actions",
        render: props.profilesToActions,
      },
      {
        id: "profiles-to-ecommerce-module-products",
        title: "Products",
        render: props.profilesToEcommerceModuleProducts,
      },
    ].filter(
      (
        section,
