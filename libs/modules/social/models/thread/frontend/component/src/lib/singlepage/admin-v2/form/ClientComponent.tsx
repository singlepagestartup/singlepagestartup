...
import { api } from "@sps/social/models/thread/sdk/client";
import { useForm } from "react-hook-form";
import { z } from "zod";
import { zodResolver } from "@hookform/resolvers/zod";
import { variants, insertSchema } from "@sps/social/models/thread/sdk/model";
    ...
    return [
      {
        id: "chats-to-threads",
        title: "Chats",
        render: props.chatsToThreads,
      },
      {
        id: "threads-to-messages",
        title: "Messages",
        render: props.threadsToMessages,
      },
      {
        id: "threads-to-ecommerce-module-products",
        title: "Products",
        render: props.threadsToEcommerceModuleProducts,
      },
    ].filter(
      (
        section,
