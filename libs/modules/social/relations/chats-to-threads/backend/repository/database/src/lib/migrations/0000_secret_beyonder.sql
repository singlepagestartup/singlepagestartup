...
ALTER TABLE "sl_cs_to_ts_v33" ADD CONSTRAINT "sl_cs_to_ts_v33_td_id_sl_thread_id_fk" FOREIGN KEY ("td_id") REFERENCES "public"."sl_thread"("id") ON DELETE cascade ON UPDATE no action;