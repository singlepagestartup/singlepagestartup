...
import { api } from "@sps/social/relations/messages-to-file-storage-module-files/sdk/client";
...
import {
  variants,
  insertSchema,
} from "@sps/social/relations/messages-to-file-storage-module-files/sdk/model";
