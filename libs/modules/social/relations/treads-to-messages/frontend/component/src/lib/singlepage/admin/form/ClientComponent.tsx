...
import {
  variants,
  insertSchema,
} from "@sps/social/relations/treads-to-messages/sdk/model";
import { api } from "@sps/social/relations/treads-to-messages/sdk/client";
