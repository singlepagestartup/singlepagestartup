...
import { api } from "@sps/ecommerce/relations/orders-to-social-module-chats/sdk/client";
...
export function Component(props: IComponentPropsExtended) {
  ...
  const form = useForm<z.infer<typeof insertSchema>>({
    ...
    defaultValues: {
      ...
      socialModuleChatId: props.data?.socialModuleChatId || "",
    },
  });
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <SocialModuleChat
          isServer={props.isServer}
          variant="admin-select-input"
          formFieldName="socialModuleChatId"
          form={form}
        />
      </div>
    </ParentAdminForm>
