# Ecommerce Orders to Billing Module Currencies Relation

## Purpose

Links orders to currencies and stores quantity metadata for totals.
...
- `quantity`: quantity of items in this currency context.
