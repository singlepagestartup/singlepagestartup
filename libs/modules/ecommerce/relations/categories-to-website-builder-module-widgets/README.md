# Ecommerce Categories to Website Builder Module Widgets Relation

## Purpose

Links categories to website-builder widgets for embedded content blocks.
...
- `websiteBuilderModuleWidgetId`: linked widget ID.
