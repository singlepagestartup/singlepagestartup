...
import { IComponentProps as IEcommerceModuleProductCheckoutComponentProps } from "./ecommerce-module/product/checkout/interface";
...
export type IComponentProps =
  ...
  | IEcommerceModuleProductCheckoutComponentProps
