...
export function Component(props: IComponentProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Link href={ADMIN_BASE_PATH + "/rbac"}>
          <span className="inline-flex min-w-0 items-center gap-2">
            <span className="truncate">Rbac</span>
          </span>
      ...
      {isCurrentModule ? (
        <div className="mt-2 space-y-1 pl-3">
          ...
          <Identity isServer={props.isServer} url={props.url} />
          <Permission isServer={props.isServer} url={props.url} />
          <Role isServer={props.isServer} url={props.url} />
          <Subject isServer={props.isServer} url={props.url} />
