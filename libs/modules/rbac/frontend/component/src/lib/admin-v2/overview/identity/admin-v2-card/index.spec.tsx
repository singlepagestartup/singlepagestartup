...
/**
 * BDD Suite: identity card of the admin-v2 overview.
 *
 * Given: the host renders the admin-v2 overview on the server, and the
 * sensitive-route list closes the identity count to callers without a role.
 * When: the overview renders the identity card.
...
import { api as clientApi } from "@sps/rbac/models/identity/sdk/client";
...
describe("Given: the identity card of the admin-v2 overview", () => {
  afterEach(() => {
