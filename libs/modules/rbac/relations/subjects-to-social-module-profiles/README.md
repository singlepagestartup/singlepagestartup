# RBAC Subjects to Social Module Profiles Relation

## Purpose

Links subjects to social profiles.
...
- `socialModuleProfileId`: linked profile ID.

## Variants

- `default`: renders the related profile using its frontend variant.
