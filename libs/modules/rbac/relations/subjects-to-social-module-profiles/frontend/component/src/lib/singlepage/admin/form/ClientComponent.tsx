...
import { api } from "@sps/rbac/relations/subjects-to-social-module-profiles/sdk/client";
...
import {
  variants,
  insertSchema,
} from "@sps/rbac/relations/subjects-to-social-module-profiles/sdk/model";
...
export function Component(props: IComponentPropsExtended) {
  ...
  const form = useForm<z.infer<typeof insertSchema>>({
    ...
    defaultValues: {
      ...
      socialModuleProfileId: props.data?.socialModuleProfileId || "",
    },
  });
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <SocialModuleProfile
          isServer={props.isServer}
          variant="admin-select-input"
          formFieldName="socialModuleProfileId"
          form={form}
        />
      </div>
    </ParentAdminForm>
