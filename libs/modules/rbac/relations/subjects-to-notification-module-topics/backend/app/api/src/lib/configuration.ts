      ...
      repository: {
        ...
        seed: {
          ...
          filters: [
            ...
            {
              column: "notificationModuleTopicId",
              method: "eq",
              value: (data) => {
                ...
                const topicEntity = topicSeed?.seeds.find(
                  (seed) =>
                    seed.dump.id === data.entity.dump.notificationModuleTopicId,
                );

                return (
                  topicEntity?.new?.id ||
                  data.entity.dump.notificationModuleTopicId
                );
              },
            },
          ],
          transformers: [
            ...
            {
              field: "notificationModuleTopicId",
              transform: (data) => {
                const relationEntites = data.seeds
                  .find(
                    (seed) =>
