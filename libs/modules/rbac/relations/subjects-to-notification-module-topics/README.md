# RBAC Subjects to Notification Module Topics Relation

## Purpose

Links subjects to notification topics.
...
- `notificationModuleTopicId`: linked topic ID.

## Variants

- `default`: renders the related topic using its frontend variant.
