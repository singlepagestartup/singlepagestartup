import { Component as ArticleOverviewEcommerceProductListDefault } from "./article/overview/ecommerce/product/list/default";
...
export const variants = {
  "article-overview-ecommerce-product-list-default":
    ArticleOverviewEcommerceProductListDefault,
  find: Find,
