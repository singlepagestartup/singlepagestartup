import { IComponentProps as IArticleOverviewEcommerceProductListDefaultComponentProps } from "./article/overview/ecommerce/product/list/default/interface";
...
export type IComponentProps =
  | IArticleOverviewEcommerceProductListDefaultComponentProps
  | IFindComponentProps
