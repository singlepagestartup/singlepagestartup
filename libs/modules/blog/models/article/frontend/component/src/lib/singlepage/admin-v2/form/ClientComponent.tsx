...
export function Component(props: IComponentPropsExtended) {
  ...
  const relationSections = useMemo(() => {
    return [
      ...
      {
        id: "articles-to-file-storage-module-files",
        title: "Files",
        render: props.articlesToFileStorageModuleWidgets,
      },
      {
        id: "articles-to-website-builder-module-widgets",
        title: "Website widgets",
        render: props.articlesToWebsiteBuilderModuleWidgets,
      },
      {
        id: "articles-to-ecommerce-module-products",
        title: "Products",
        render: props.articlesToEcommerceModuleProducts,
      },
      {
        id: "widgets-to-articles",
        title: "Widgets",
        render: props.widgetsToArticles,
      },
    ].filter(
      (
        section,
        ...
        <TabsContent value="details" className="mt-0 pt-6">
          <div className="flex flex-col gap-6">
            ...
            <FormField
              ...
              options={variants.map((variantValue) => [
                variantValue,
                variantValue,
              ])}
            />
