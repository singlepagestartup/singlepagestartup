...
export function Component(props: IComponentPropsExtended) {
  ...
  const relationSections = useMemo(() => {
    return [
      {
        id: "inputs-to-options",
        title: "Inputs",
        render: props.inputsToOptions,
      },
      {
        id: "options-to-file-storage-module-files",
        title: "Files",
        render: props.optionsToFileStorageModuleFiles,
      },
    ].filter(
      (
        section,
  ...
  }, [props.inputsToOptions, props.optionsToFileStorageModuleFiles]);
