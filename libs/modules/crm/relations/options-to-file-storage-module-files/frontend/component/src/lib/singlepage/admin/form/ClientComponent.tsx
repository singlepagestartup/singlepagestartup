...
import { api } from "@sps/crm/relations/options-to-file-storage-module-files/sdk/client";
...
import {
  variants,
  insertSchema,
} from "@sps/crm/relations/options-to-file-storage-module-files/sdk/model";
