/**
 * BDD Suite: website-builder configuration unit contracts.
 *
...
describe("website-builder configuration unit contracts", () => {
  ...
  it("keeps module seed metadata anchored to the current module", () => {
    ...
    for (const item of sourceByPath) {
      ...
      expect(item.source).toContain('module: "website-builder"');
