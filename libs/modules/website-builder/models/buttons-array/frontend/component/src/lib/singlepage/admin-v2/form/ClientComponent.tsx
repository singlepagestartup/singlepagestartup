...
export function Component(props: IComponentPropsExtended) {
  ...
  const relationSections = useMemo(() => {
    return [
      {
        id: "buttons-arrays-to-buttons",
        title: "Buttons",
        render: props.buttonsArraysToButtons,
      },
      {
      ...
      {
        id: "slides-to-buttons-arrays",
        title: "Slides",
        render: props.slidesToButtonsArrays,
      },
      {
        id: "features-to-buttons-arrays",
        title: "Features",
        render: props.featuresToButtonsArrays,
      },
    ].filter(
      (
        section,
