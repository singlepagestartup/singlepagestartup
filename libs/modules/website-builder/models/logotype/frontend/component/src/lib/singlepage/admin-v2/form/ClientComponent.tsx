...
export function Component(props: IComponentPropsExtended) {
  ...
  const relationSections = useMemo(() => {
    return [
      ...
      {
        id: "logotypes-to-file-storage-module-files",
        title: "Files",
        render: props.logotypesToFileStorageModuleWidgets,
      },
    ].filter(
      (
        section,
  ...
  }, [props.widgetsToLogotypes, props.logotypesToFileStorageModuleWidgets]);
