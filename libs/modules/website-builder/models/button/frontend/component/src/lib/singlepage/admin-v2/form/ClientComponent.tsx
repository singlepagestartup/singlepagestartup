...
export function Component(props: IComponentPropsExtended) {
  ...
  const relationSections = useMemo(() => {
    return [
      ...
      {
        id: "buttons-to-file-storage-module-files",
        title: "Files",
        render: props.buttonsSpsFileStorageModuleWidgets,
      },
    ].filter(
      (
        section,
  ...
  }, [props.buttonsArraysToButtons, props.buttonsSpsFileStorageModuleWidgets]);
