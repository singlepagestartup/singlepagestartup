...
export function Component(props: IComponentPropsExtended) {
  ...
  const relationSections = useMemo(() => {
    return [
      {
        id: "widgets-to-buttons-arrays",
        title: "Buttons arrays",
        render: props.widgetsToButtonsArrays,
      },
      {
        id: "widgets-to-features",
        title: "Features",
        render: props.widgetsToFeatures,
      },
      {
        id: "widgets-to-file-storage-module-files",
        title: "Files",
        render: props.widgetsToFileStorageModuleFiles,
      },
      {
        id: "widgets-to-logotypes",
        title: "Logotypes",
        render: props.widgetsToLogotypes,
      },
      {
        id: "widgets-to-sliders",
        title: "Sliders",
        render: props.widgetsToSliders,
      },
    ].filter(
      (
        section,
