...
import { api } from "@sps/knowledge/models/chunk/sdk/client";
import { useForm } from "react-hook-form";
import { z } from "zod";
import { zodResolver } from "@hookform/resolvers/zod";
import { variants, insertSchema } from "@sps/knowledge/models/chunk/sdk/model";
...
export function Component(props: IComponentPropsExtended) {
  ...
  const form = useForm<z.infer<typeof insertSchema>>({
    ...
    defaultValues: {
      ...
      embedding: props.data?.embedding || Array.from({ length: 768 }, () => 0),
      chunkIndex: props.data?.chunkIndex || 0,
      tokenEstimate: props.data?.tokenEstimate || 0,
  ...
  const relationSections = useMemo(() => {
    return [
      {
        id: "sources-to-chunks",
        title: "Sources",
        render: props.sourcesToChunks,
      },
    ].filter(
      (
        section,
        ...
        <TabsContent value="details" className="mt-0 pt-6">
          <div className="flex flex-col gap-6">
            ...
            <FormField
              ...
              name="tokenEstimate"
              form={form}
              placeholder="Type token estimate"
            />
