...
import { api } from "@sps/knowledge/models/source/sdk/client";
import { useForm } from "react-hook-form";
import { z } from "zod";
import { zodResolver } from "@hookform/resolvers/zod";
import { variants, insertSchema } from "@sps/knowledge/models/source/sdk/model";
...
export function Component(props: IComponentPropsExtended) {
  ...
  const relationSections = useMemo(() => {
    return [
      {
        id: "sources-to-file-storage-module-files",
        title: "Files",
        render: props.sourcesToFileStorageModuleFiles,
      },
      {
  ...
  }, [props.sourcesToChunks, props.sourcesToFileStorageModuleFiles]);
