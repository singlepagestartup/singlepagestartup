...
export function Component(props: IComponentProps) {
  const isCurrentModule = props.url.startsWith(ADMIN_BASE_PATH + "/host");
  ...
  return (
    ...
    >
      ...
      >
        <Link href={ADMIN_BASE_PATH + "/host"}>
      ...
      {isCurrentModule ? (
        <div className="mt-2 space-y-1 pl-3">
          <Layout isServer={props.isServer} url={props.url} />
          <Metadata isServer={props.isServer} url={props.url} />
          <Page isServer={props.isServer} url={props.url} />
